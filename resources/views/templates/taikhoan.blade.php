        ...
        <div class="row">
            <div class="col-lg-3 col-md-4">
                ...
                <div class="acc-info">
                    ...
                    <a href="cap-nhat-tai-khoan.html" title="" class="btn mb-2 w-75 btn-update">Cập nhật thông tin</a>
                    <a href="lich-su-mua-hang.html" title="" class="btn w-75 mb-2 btn-update">Lịch sử mua hàng</a>
                </div>
            </div>
            ...
            <div class="col-lg-9 col-md-8">
                <div class="acc-content">
                    ...
                    <div class="acc-buy-his">
                        ...
                        <!-- <p class="text-lg-left text-center mt-3"><a href="lich-su-mua-hang.html" title="" class="see-more font-italic">Xem thêm</a></p> -->
                    </div>
                </div>
            </div>
        </div>
